...
namespace quanlykhodl.Service
{
    public class DeliverynoteService : IDeliverynoteService
    {
        ...
        private listArea loadDataAreaProductAreaLocation(productDeliverynote data)
        {
            ...
            //var checkproductLocationData = _context.productlocations.Where(x => x.id_product == data.product_map && x.id_shelf == data.shelf_id && x.location == data.location && !x.deleted && x.isaction).FirstOrDefault();
                ...
                if (checkArea != null)
                {
                    if (checkArea.floor_id != null)
                    {
                        ...
                        if (checkWarehourse != null)
                        {
                            ...
                            dataItem.isAction = checkDeliverynote.isaction.Value;
                        }
                    }
                }
